...
\begin{figure}[H]
\begin{center}
	\includegraphics[scale=.65]{images/MVVMPattern.png}
\end{center}
...
Quellen: \cite{_model_2018} \cite{_model-view-controller_????}
\begin{figure}[H]
\begin{center}
