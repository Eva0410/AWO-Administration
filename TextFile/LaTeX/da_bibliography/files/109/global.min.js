...
function createToc() {
    ...
    var drawToc = function (json) {
        ...
        $$1(function () {
            ...
            try {
                var scrollAmount = ($selectedParent.offset().top - $tocHolder.offset().top - $selected.height()) - ($tocHolder.height() / 3);
...
function getTabbableElements(node) {
    var nodes = Array.from(node.querySelectorAll(tabbable.join(',')))
...
function restoreTabIndexes(nodes) {
    nodes.forEach(function (node) {
        node.element.tabIndex = node.tabindex;
    });
}
...
var Dialog = (function () {
    function Dialog(container) {
        ...
        this.closeButton = button.firstElementChild;
        this.active = false;
    }
    Dialog.prototype.show = function (view, options) {
        ...
        if (options.modal) {
            this.disabledElements = getTabbableElements(document$1);
            this.disabledElements.forEach(function (node) {
                node.element.tabIndex = -1;
            });
        }
        document$1.body.insertAdjacentElement('afterbegin', this.container);
        document$1.body.insertAdjacentElement('afterbegin', this.closeButton);
        if (options.modal) {
            this.overlay.addEventListener('click', this.hide.bind(this));
            document$1.body.insertAdjacentElement('afterbegin', this.overlay);
    ...
    Dialog.prototype.hide = function () {
        ...
        restoreTabIndexes(this.disabledElements);
...
$$1(function () { return initializeLightBox(document.querySelector('#main')); });
