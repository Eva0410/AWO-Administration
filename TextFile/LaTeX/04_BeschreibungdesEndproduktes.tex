...
\end{lstlisting}
Genau die selbe Mehtode wird benutzt, wenn eine Rechnung erstellt wird.
\begin{figure}[H]
\begin{center}
...
\end{lstlisting}
Dieses Event wird von der ListView bereitgestellt.
